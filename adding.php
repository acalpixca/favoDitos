...
// aqu� dividimos las categor�as separadas por comas, le quitamos los espacios en blanco
...
//echo '<br/>La lista de categor�as, en variable GET: ' . $_GET['categories'] . '<br/>';
//echo '<br/>La lista de categor�as, en array ya splitteado: ' . $cat_list . '<br/>';
//var_dump($cat_list);
while ($i<count($cat_list))
{
	$category=trim($cat_list[$i]);
	//echo 'Bucle. Categor�a ' . $i . ' es, una vez trimmeada: ' . $category . '<br/>';
	if (categoryExists($category)==-1)
	{
		//a�adir la categor�a a category (userId, categoryId)
	...
	// Aqu� abajo insertamos el resultado de categoryExists para no evitar quasi duplicaciones, como "categoria" y "Categor�a"
